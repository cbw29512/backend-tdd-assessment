...
You may also benefit from having a separate `main()` function in your echo.py application. A main() function can be invoked from the command line directly, as well as be imported by your test program and tested independently.
