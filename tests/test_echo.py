...
class TestEcho(unittest.TestCase):
    ...
    def test_lower(self):
        ...
        process = subprocess.Popen(
            ["python", "./echo.py", "-l", "Hello"], stdout=subprocess.PIPE)
        stdout, _ = process.communicate()
    ...
    # When a user provides all three options, they should be applied in the order listed in the
    # helpful usage message that Argparse constructs from the argument definitions.
